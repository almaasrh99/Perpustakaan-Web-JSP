...
<div id="con">
            <h3 align="center">Daftar Penerbit Buku</h3>
...
<input type="button" class="btn btn-primary btn-md" value="+ Tambah " /></a></td>
            ...
            try {
                ...
                String Data = "select * from penerbit";
	...
	<thead>
                ...
                %>
                <tr>
                    <td><%=rs.getString("id_penerbit")%></td>
                    <td><%=rs.getString("nama_penerbit")%></td>
                    
                    <td><a href="edit.jsp?u=<%=rs.getString("id_penerbit")%>" ><input type="button" class="btn btn-primary btn-md" value="Edit " /></a> | <a href="hapus.jsp?d=<%=rs.getString("id_penerbit")%>" ><input type="button" class="btn btn-warning btn-md" value="Hapus " /></a></td>
                </tr>
                <%   }    %>
            </table>
            <%
