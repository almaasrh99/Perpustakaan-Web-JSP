...
<div id="con2">
            ...
            <form action="editaksi.jsp" method="post">
                ...
                %>   
                <p>
                    <label></label><input type="hidden"  class="form-control"  name="id_bahasa_buku" value='<%=rs.getString("id_bahasa_buku")%>'/>
                </p>
                <p>
                    <input type="text" name="bahasa_buku"  class="form-control"  value='<%=rs.getString("bahasa_buku")%>'/>
                </p>
                
                <p>
                    <label></label><input type="submit" class="btn btn-primary btn-md" name="submit" value="Update"/>
                     <tr align="right"><td colspan="5"><a href="bahasa_buku.jsp">
