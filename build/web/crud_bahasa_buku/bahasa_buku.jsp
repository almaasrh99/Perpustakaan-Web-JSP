<%-- 
    Document   : bahasa_buku
    Created on : May 05, 2019, 9:24:38 AM
    Author     : Almaas
...
<div id="con">
            <h3 align="center">Daftar Bahasa Buku</h3>
...
<input type="button" class="btn btn-primary btn-md" value="+ Tambah " /></a></td>
            ...
            try {
                ...
                String Data = "select * from bahasa_buku";
	...
	<thead>
                <tr style="background-color: green;">
                    <th widht="5%">Id_bahasa_buku</th>
                    <th widht="8%">Bahasa Buku</th>
                ...
                %>
                <tr>
                    <td><%=rs.getString("id_bahasa_buku")%></td>
                    <td><%=rs.getString("bahasa_buku")%></td>
                    
                   <td><a href="edit.jsp?u=<%=rs.getString("id_bahasa_buku")%>" ><input type="button" class="btn btn-primary btn-md" value="Edit " /></a> | <a href="hapus.jsp?d=<%=rs.getString("id_bahasa_buku")%>" ><input type="button" class="btn btn-warning btn-md" value="Hapus " /></a></td>
                </tr>
                <%   }    %>
            </table>
            <%
