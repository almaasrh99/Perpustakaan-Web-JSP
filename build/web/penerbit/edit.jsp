...
<div id="con2">
            ...
            <form action="editaksi.jsp" method="post">
                ...
                try {
                    ...
                    String Data = "select * from penerbit where id_penerbit='"+num+"'";
                    rs = statement.executeQuery(Data);
                    while (rs.next()) {
                %>   
                <p>
                    <label></label><input type="hidden" class="form-control" name="id_penerbit" value='<%=rs.getString("id_penerbit")%>'/>
                </p>
                <p>
                    <label>Nama</label><input type="text" class="form-control" name="nama_penerbit" value='<%=rs.getString("nama_penerbit")%>'/>
                </p>
                
                <p>
                   <label></label><input type="submit" class="btn btn-primary btn-md" name="submit" value="Update"/>
                     <tr align="right"><td colspan="5"><a href="penerbit.jsp">
