...
<div id="con2">
            ...
            <form action="editaksi.jsp" method="post">
                ...
                try {
                    ...
                    String Data = "select * from pengarang where id_pengarang='"+num+"'";
                    rs = statement.executeQuery(Data);
                    while (rs.next()) {
                %>   
                <p>
                    <label></label><input type="hidden" class="form-control" name="id_pengarang" value='<%=rs.getString("id_pengarang")%>'/>
                </p>
                <p>
                    <label>Nama</label><input type="text" class="form-control" name="nama_pengarang" value='<%=rs.getString("nama_pengarang")%>'/>
                </p>
                
                <p>
                    <label></label><input type="submit" class="btn btn-primary btn-md" name="submit" value="Update"/>
                    <tr align="right"><td colspan="5"><a href="pengarang.jsp">
<input type="button" class="btn btn-success btn-md" value="Kembali" /></a></td>
                </p>
                <%   }
                    rs.close();
                    statement.close();
