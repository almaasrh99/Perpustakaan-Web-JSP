<%-- 
    Document   : pengarang
    Created on : Nov 25, 2016, 4:01:31 PM
    Author     : Iqbal
    Correct by : Danboru
--%>
...
<div id="con">
            <h3 align="center">Daftar Pengarang Buku</h3>
...
<input type="button" class="btn btn-primary btn-md" value="+ Tambah " /></a></td>
            ...
            try {
                ...
                String Data = "select * from pengarang";
	...
	<thead>
                ...
                %>
                <tr>
                    <td><%=rs.getString("id_pengarang")%></td>
                    <td><%=rs.getString("nama_pengarang")%></td>
                    
                    <td><a href="edit.jsp?u=<%=rs.getString("id_pengarang")%>" ><input type="button" class="btn btn-primary btn-md" value="Edit " /></a> | <a href="hapus.jsp?d=<%=rs.getString("id_pengarang")%>" ><input type="button" class="btn btn-warning btn-md" value="Hapus " /></a></td>
                </tr>
                <%   }    %>
            </table>
            <%
