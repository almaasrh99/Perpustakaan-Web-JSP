...
<div id="con2">
            ...
            <form action="editaksi.jsp" method="post">
                ...
                %>   
                <p>
                    <label></label><input type="hidden" class="form-control" name="id_jenis_buku" value='<%=rs.getString("id_jenis_buku")%>'/>
                </p>
                <p>
                    <label>Nama</label><input type="text" class="form-control" name="jenis_buku" value='<%=rs.getString("jenis_buku")%>'/>
                </p>
                
                <p>
                    <label></label><input type="submit" class="btn btn-primary btn-md" name="submit" value="Update"/>
                    <tr align="right"><td colspan="5"><a href="jenis_buku.jsp">
